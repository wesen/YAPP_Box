...
- [x] Week 3: Create push_buttons schema.yaml with all fields, nested objects, and test cases
- [x] Week 3: Run schemagen to generate schema_gen.go for push_buttons
- [x] Week 3: Refactor push_buttons builder.go to use generated types
- [x] Week 3: Implement CustomValidate() for conditional push_buttons validation
- [x] Week 3: Test full YAML → validation → SCAD pipeline with push_buttons examples
- [x] Week 3: Fix any issues discovered with generated code or validation flow
...
- [x] Week 5: Create cutouts schema.yaml and convert module
- [x] Week 5: Run full test suite across all converted modules
- [x] Week 5: Verify all existing YAML examples still work with new validation
- [x] Week 6: Implement pkg/resolver/validation.go with validateAgainstSchemas() and validateConstraints()
- [x] Week 6: Integrate two-phase validation into Resolve() function
- [x] Week 6: Implement pkg/docs/schema_help.go for schema → markdown rendering
